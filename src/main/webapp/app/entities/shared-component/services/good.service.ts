...
export class GoodService {
    ...
    private resourceUrl = 'api/goods';
    private resourceSearchUrl = 'api/_search/goods';
    ...
    executeProcess(good: any): Observable<String> {
        const copy = this.convert(good);
    ...
    private convert(good: Good): Good {
        const copy: Good = Object.assign({}, good);

        // copy.dateIntroduction = this.dateUtils.toDate(good.dateIntroduction);
        return copy;
    }
}
