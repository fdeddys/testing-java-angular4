...
export class MarketComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/market'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    sort() {
        ...
        if (this.predicate !== 'idMarket') {
            result.push('idMarket');
        }
        return result;
    }
    ...
    executeProcess(data) {
        this.marketService.executeProcess(0, null, data).subscribe(
    ...
    updateRowData(event) {
        if (event.data.id !== undefined) {
            this.marketService.update(event.data)
                .subscribe((res: Market) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        } else {
            this.marketService.create(event.data)
                .subscribe((res: Market) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        }
    }

    private onRowDataSaveSuccess(result: Market) {
        this.toasterService.showToaster('info', 'Market Saved', 'Data saved..');
    }
