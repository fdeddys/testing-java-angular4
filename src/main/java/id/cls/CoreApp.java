...
import id.cls.base.BootStrapApps;
import id.cls.config.ApplicationProperties;
import id.cls.config.DefaultProfileUtil;
...
public class CoreApp implements CommandLineRunner {
    ...
    private final BootStrapApps boot;

    public CoreApp(Environment env, BootStrapApps boot) {
        this.env = env;
        this.boot = boot;
    }
